...
| I2 · Lecturas documentales | Vista compuesta del Técnico (G-16), Mi legajo del Supervisor y Equipo supervisado separados (G-17), apertura contextual de legajo, propuestas, matriz vigente, vencimientos y auditoría | G-01 tipado por pantalla; selectores SEL-01…33 sin IDs libres; G-16 para Técnico; G-17 para los dos contextos del Supervisor; permisos G-04/G-05 conciliados | Lecturas reales, vacíos distintos de falta de permiso; paginación servidor; no indicadores calculados de dominio |
