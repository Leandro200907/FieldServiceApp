...
const items: ItemCalendario[] = [
  ...
  { categoria: 'documento', id: 'cal-veh-01', referencia: 'evidencia:documento:cal-veh-01', sujeto_id: 'vehiculo-vx23', tipo_sujeto: 'vehiculo', identificador_natural: 'Unidad VX-23', requisito_definicion_id: 'req-vtv', requisito: 'VTV', vigente_desde: '2026-08-01', vigente_hasta: '2026-09-20', estado_confirmacion: 'confirmado_en_fuente', archivo_validacion: 'invalido', dias_para_vencer: -1 },
  ...
  { categoria: 'documento', id: 'cal-eqp-02', referencia: 'evidencia:documento:cal-eqp-02', sujeto_id: 'equipo-eq087', tipo_sujeto: 'equipo', identificador_natural: 'Medidor de presión EQ-087', requisito_definicion_id: 'req-certificado-calibracion', requisito: 'Certificado de calibración', vigente_desde: '2026-08-21', vigente_hasta: '2026-10-25', estado_confirmacion: 'verificado', archivo_validacion: 'pendiente', dias_para_vencer: 34 },
];

const backlogItems: ItemBacklog[] = [
  { commitment_id: 'OC-45000218', referencia: 'oc:OC-45000218', oc_referencia: 'OC 45000218', cliente_id: 'cliente-norte', locacion_id: 'locacion-norte-01', vigencia_desde: '2026-09-24', vigencia_hasta: '2026-09-30', estado: 'sin_riesgos_detectados', primer_quiebre: null, capacidad_documental_potencial_hoy: { persona: 12, vehiculo: 4, equipo: 9 }, origen_calculo: 'ultima_decision_visible', motivos_resumidos: [] },
  { commitment_id: 'OC-45000221', referencia: 'oc:OC-45000221', oc_referencia: 'OC 45000221', cliente_id: 'cliente-norte', locacion_id: 'locacion-norte-01', vigencia_desde: '2026-09-27', vigencia_hasta: '2026-10-04', estado: 'riesgo_documental', primer_quiebre: '2026-09-29', capacidad_documental_potencial_hoy: { persona: 7, vehiculo: 2 }, origen_calculo: 'ultima_decision_visible', motivos_resumidos: ['Apto médico: persona_0077 vence el 2026-09-29 sin candidato de respaldo detrás.'] },
  { commitment_id: 'OC-45000224', referencia: 'oc:OC-45000224', oc_referencia: 'OC 45000224', cliente_id: 'cliente-sur', locacion_id: 'locacion-sur-02', vigencia_desde: '2026-09-22', vigencia_hasta: '2026-09-26', estado: 'bloqueo_confirmado', primer_quiebre: '2026-09-22', capacidad_documental_potencial_hoy: { persona: 0, vehiculo: 1 }, origen_calculo: 'ultima_decision_visible', motivos_resumidos: ['VTV: ningún candidato de tipo vehiculo lo cubre en este tramo.'] },
  { commitment_id: 'OC-45000231', referencia: 'oc:OC-45000231', oc_referencia: null, cliente_id: 'cliente-sur', locacion_id: 'locacion-sur-02', vigencia_desde: '2026-10-01', vigencia_hasta: '2026-10-06', estado: 'pendiente_de_planificacion', primer_quiebre: null, capacidad_documental_potencial_hoy: {}, origen_calculo: 'candidatos_del_alcance', motivos_resumidos: ['No hay decisión visible para esta OC ni candidatos en el alcance de quien consulta'] },
  { commitment_id: 'OC-45000236', referencia: 'oc:OC-45000236', oc_referencia: 'OC 45000236', cliente_id: 'cliente-norte', locacion_id: 'locacion-norte-03', vigencia_desde: '2026-10-05', vigencia_hasta: '2026-10-10', estado: 'sin_matriz', primer_quiebre: null, capacidad_documental_potencial_hoy: {}, origen_calculo: 'candidatos_del_alcance', motivos_resumidos: ['No hay matriz vigente para (cliente_id, locacion_id, tipo_servicio_id) al día de ingreso de la OC'] },
  { commitment_id: 'OC-45000240', referencia: 'oc:OC-45000240', oc_referencia: 'OC 45000240', cliente_id: 'cliente-sur', locacion_id: 'locacion-sur-02', vigencia_desde: '2026-10-12', vigencia_hasta: '2026-10-18', estado: 'requiere_revision', primer_quiebre: '2026-10-12', capacidad_documental_potencial_hoy: { persona: 3, vehiculo: 1 }, origen_calculo: 'ultima_decision_visible', motivos_resumidos: ['Inducción de locación: depende de un documento que requiere revisión, no se cuenta como cobertura real.'] },
];
