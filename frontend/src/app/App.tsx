...
// página que no fuera 'perfil' — ignoraba que calendario-vigencias/proyeccion-backlog
// pueden estar realmente conectadas detrás de su propio flag (`access.ts`), y seguía
// diciendo "Pendiente de integración" aunque se prendiera. El resto de las pantallas SÍ
// son siempre diseño sin datos reales — para ellas el badge de "pendiente" sigue siendo
// exacto.
