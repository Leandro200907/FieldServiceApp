...
export function BusinessDesign({ page, technicalNotes = false, roles = [] }: { page: Page; technicalNotes?: boolean; roles?: readonly string[] }) {
  ...
  if (page.id === 'mi-legajo') return <>
    ...
    {technicalNotes && <p className="technical-note">G-05 / G-16 · Sin selectores de persona o recursos. GET /v1/consultas/mi_legajo existe en db400e6; integración bloqueada por A-01 de la auditoría de custodias. No se presume un único vehículo.</p>}
  </>;
